...
// functii pt. foreach
//template <class TemplateObject> void GTVector<TemplateObject>::__ForEachInit(FOREACH_DATA<TemplateObject> &fd)
//{
//	fd.Data=NULL;
//	fd.index=-1;
//	fd.maxValue=ElementsCount;
//}
//template <class TemplateObject> void GTVector<TemplateObject>::__ForEachClose(FOREACH_DATA<TemplateObject> &fd)
//{
//}
//template <class TemplateObject> bool GTVector<TemplateObject>::__ForEachNext(FOREACH_DATA<TemplateObject> &fd)
//{
//	fd->index++;
//	return (fd->index<ElementsCount);
//}
//template <class TemplateObject> void GTVector<TemplateObject>::__ForEachGet(FOREACH_DATA *fd,int index,void *variable)
//{
//	if (index==0)
//		*((TemplateObject *)variable) = *(Get(fd->index));
//	if (index==1)
//		*(unsigned int *)variable = fd->index;
//}
