...
FunctionInfo fi[] = {
			{"TotalPoz", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::TotalPozitive)},
			{"TotalNeg", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::TotalNegative)},
			{"PozCount", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::Pozitive)},
			{"NegCount", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::Negative)},
			{"PozProc", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcPozitive)},
			{"NegProc", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcNegative)},
			{"ProcAverage", 	(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcAverage)},
			{"ProcTotal", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcTotal)},
			{"Poz/Neg", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::RapPozNeg)},
			{"ProcDiff", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcDiff)},
			...
			{"InformationGain", (GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::InformationGain)},
			{"ProcTo100", 		(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::ProcTo100)},
			{"AbsProcTo100", 	(GML::ML::FeatStatComputeFunction)&(GML::ML::FeatStatsFunctions::AbsProcTo100)},
